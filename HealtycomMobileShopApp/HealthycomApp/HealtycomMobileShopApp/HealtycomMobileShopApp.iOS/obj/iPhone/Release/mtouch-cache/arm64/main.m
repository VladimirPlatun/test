...
extern void *mono_aot_module_HealtycomMobileShopApp_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_HealtycomMobileShopApp_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_HealtycomMobileShopApp_info);
	...
	mono_aot_register_module (mono_aot_module_Rating_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "HealtycomMobileShopApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
